...
<head>
	...
	<title>Vikas College</title>
  	...
  	<link rel="shortcut icon" href="{{URL::asset('website/img/title_logo.jpg')}}">
...
<div class="container-fluid z-depth-1">
	...
	<div class="hide-on-med-and-down row valign-wrapper" id="logo"
		...
		<div class="hide-on-med-and-down row valign-wrapper" id="logo"
			style="padding: 0px; margin: 0px;">
			<div class="col s12  m8 l6 offset-m1 offset-l1">
			...
			<input type="text" name="search" placeholder="Search.."
				calss="col s10  m6 "
				style="margin-top: 20px; border-color: background-color: #f44336;" id="searchbox" onkeydown="searchFunction()">

			&nbsp;&nbsp;&nbsp;&nbsp;
			<a class="btn btn-primary"
				style="height: 43px; background-color: #f44336;" href="/login">Login</a>
	...
	<div id="nav" >
		<nav class="z-depth-0" style="height:50px;line-height:50px;background-color:#373737">
			<div class="container">
				<div class="nav-wrapper">
					...
					<ul class="right hide-on-med-and-down">
						<li id="li1" {{{ (Request::is('/') ? 'class=active
								' : '') }}} style="height: 50px"><a href="/"
								style="height: 50px"><img alt="Home"
									src="{{URL::asset('website/img/home-icon-md.png')}}"
									height="28px" width="34px"
									style="padding: 2px; margin-top: 15px;"></a></li>
					...
					<ul class="side-nav" id="mobile-demo" style="background-color:#373737;color:#fff;">
						<input type="text" name="search" placeholder="Search.." id="searchbox"
								calss="col s10  m6 "
								style="margin: 5px; border-color: background-color: #f44336; width: 90%; color: #000;">
